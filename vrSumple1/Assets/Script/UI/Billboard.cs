...
namespace HoloToolkit.Unity
{
    ...
    public class Billboard : MonoBehaviour
    {
        ...
        [Tooltip("プレイヤーのカメラのTransformを指定. (DefaultではCenterEyeAnchor)")]
        [SerializeField]
        private Transform PlayerRootCamera;
        ...
        private void OnEnable()
        {
            ...
            if (PlayerRootCamera == null)
                PlayerRootCamera = Camera.main.transform;
        }
        ...
        private void LateUpdate()
        {
            ...
            {
                transform.rotation = Quaternion.LookRotation(-directionToTarget, PlayerRootCamera.transform.up);
            }
            else
            {
